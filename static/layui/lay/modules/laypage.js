    ...
    p.on = function(a, t, e) {
        ...
        p.prototype.view = function() {
            var a = this,
                ...
                e = [],
                r = {};
            var count='<span class="layui-laypage-count">共 ' + t.count + " 条</span>";
            ...
            return t.pages > t.groups && r.end < t.pages && t.last && 0 !== t.groups && e.push('<span>&#x2026;</span><a href="javascript:;" class="layui-laypage-last" title="&#x5C3E;&#x9875;"  data-page="' + t.pages + '">' + t.pages + "</a>"),
